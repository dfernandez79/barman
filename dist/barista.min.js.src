...
define('src/barista',['require','exports','module','underscore'],function (require, exports, module) {
...
var _ = require('underscore'),
    ...
    ERROR_MESSAGES = {
        ...
        mergeConflict: 'This property was defined by multiple merged objects, override it with the proper implementation',
...
function mergeConflict() {
    throw new Error(ERROR_MESSAGES.mergeConflict);
}


function subclassResponsibility() {
    throw new Error(ERROR_MESSAGES.subclassResponsibility);
}
...
function merge() {
    ...
    each(arguments, function ( obj ) {
        ...
        mapProperties(obj, function ( value, prop ) {

            return ( !isUndefined(this[prop]) && this[prop] !== value ) ? mergeConflict : value;
...
var AbstractClassFactory = Class.create({
    ...
    createClass: subclassResponsibility
